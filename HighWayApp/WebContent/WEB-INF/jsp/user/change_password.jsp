...
function check(){
    ...
    if(old_password==''||old_password==null){
  	  $("#tishi").html("请输入旧密码！"); 		
  	modifyCss();}else if(old_password.length<6){
  	  			//alert(cu_password.length);
  				 $("#tishi").html("密码长度不能少于6位！"); 		
   				modifyCss();
   				return;
  	  			}else if(cu_password==''||cu_password==null){
  				 $("#tishi").html("请输入新密码！"); 		
  				modifyCss();
  				return;
  	  			}else if(cu_password.length<6){
  	  	  			//alert(cu_password.length);
  	  				 $("#tishi").html("密码长度不能少于6位！"); 		
  	   				modifyCss();
  	   				return;
 				...
 				return;
  				...
  				return;}
  	    			 ...
  	    			 doButtonSubmit(document.forms[0], 'doUpdatePassword', 'submitField');
      	    		}
		}
</script>
...
<div class="page1">
  <header>
   <h3 style="text-align:center;color:#000; ">修改密码</h3><a class="back" href="#" onClick=" doButtonSubmit(document.forms[0], 'backToUserInfo', 'submitField');"></a>    
  </header>
  <div class="content1">
   <html:form action="/CarpoolUser.do" method="get" >     
    <section class="main">
      ...
      <div class="main1" style="margin:4px 0 20px 0">
       <p  class="m-top1">旧&nbsp;&nbsp;密&nbsp;&nbsp;码：<input type="password" name="old_password" id="old_password"  placeholder="请输入旧密码" style="width:65%"></p>
        <p  class="m-top1">新&nbsp;&nbsp;密&nbsp;&nbsp;码：<input type="password"  name="cu_password" id="cu_password" placeholder="6位以上字母/数字" style="width:65%"></p><p>确认密码：<input type="password" placeholder="请再次输入密码"  name="confirm_password" id="confirm_password" style="width:65%"></p>
      </div>
      
      
     
       <a href="#" class="button" style="clear:both" onClick="check();">确定</a>
