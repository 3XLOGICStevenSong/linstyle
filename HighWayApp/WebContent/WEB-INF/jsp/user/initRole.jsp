			...
			<html:form method="get" action="/CarpoolUser.do">
				<div data-role="header" data-position="fixed" data-tap-toggle="false">
					...
					<div class="index"  style="margin-top:120px">
						...
						<a href="javascript:void(0);return;" class="in1" onclick="saveValue('dp_flag','0');doButtonSubmit(document.forms[0], 'doInitRole', 'submitField')"><p>我是车主</p></a>
				  			<a href="javascript:void(0);return;" class="in1" onclick="saveValue('dp_flag','1');doButtonSubmit(document.forms[0], 'doInitRole', 'submitField')"><p>我是乘客</p></a>
						</div>
