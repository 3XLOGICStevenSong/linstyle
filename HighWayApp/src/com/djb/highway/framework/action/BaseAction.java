...
public class BaseAction extends EventDispatchAction {
     ...
     * @exception Exception
     */
    public void toJson(HttpServletResponse response, Object dto)
            throws Exception {

        response.setContentType("application/json; charset=utf-8");
        PrintWriter out = response.getWriter();
        Gson gson = new GsonBuilder().disableHtmlEscaping().create();
        //logger.info("GSON:", "GSON:"+gson.toJson(dto));
    ...
    public void formMessages(BaseDTO dto, String key, Object[] args) {
        BaseDTO.MessageData messageData = dto.new MessageData(key,
                ResourceLocator.getI18NMessage(this, key, args));
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        String methodName = super.getMethodName(mapping, form, request,
                response, mapping.getParameter());

        BaseDTO dto = (BaseDTO) form;
        logger.debug(methodName, ">>" + methodName);
        
        // test
        // if (!CommonUtil.isNullOrBlank(this.getClass().getName()) &&
        // this.getClass().getName().equals("com.djb.highway.road.action.CameraAction"))
        // {
        // logger.error(methodName, ">>ClassName:" + this.getClass().getName() +
        // "new Date().getTime()[" + (new Date().getTime()) + "]毫秒");
        // }
        ...
        try {
            ...
            logger.error(methodName, "<<[End:execute] ClassName:"
                    + this.getClass().getName() + "经过时间[" + lngTime + "]毫秒");
