package com.djb.highway.framework.log;

import java.io.PrintWriter;
import java.io.StringWriter;

import com.djb.highway.framework.UserInfo;



/**
 * <P>BaseLoggerのラッパークラス.先頭・最後尾に決まった文字列を出力するために使用.</P>
 *
 *
 * @author	Wangjiquan
 *
...
public class Logger {
	...
	/**
	 * <P>DEBUG優先度を使ってメッセージオブジェクトをログ出力します. </P>
	...
	/**
	 * <P>ERROR優先度を使ってメッセージオブジェクトをログ出力します. </P>
	...
	/**
	 * <P>FATAL優先度を使ってメッセージオブジェクトをログ出力します. </P>
	...
	/**
	 * <P>INFO優先度を使ってメッセージオブジェクトをログ出力します. </P>
	...
	/**
	 * <P>WARN優先度を使ってメッセージオブジェクトをログ出力します. </P>
