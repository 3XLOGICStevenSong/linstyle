...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("cn.com.dbridge.jtraining"))
    ...
    private ApiInfo apiInfo() {
        Contact contact = new Contact("陈健飞", "https://dbridge.com.cn/",
                "chen.jf89@outlook.com");
        return new ApiInfoBuilder()
                .title("赴日工人培训项目使用Swagger2构建RESTful APIs").contact(contact)
                .version("2.0").build();
    }
