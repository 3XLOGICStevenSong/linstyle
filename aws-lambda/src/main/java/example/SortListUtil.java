...
public class SortListUtil {
	...
	public List<?> sort(List<?> list, final String field, final String sort) {
	 ...
	 */
	// @SuppressWarnings({ "unchecked", "rawtypes" })
	// public List<?> sortByMethod(List<?> list, final String method, final
	// String sort) {
	// Collections.sort(list, new Comparator() {
	// public int compare(Object a, Object b) {
	// int ret = 0;
	...
	// if (type == int.class) {
	// ret = ((Integer) m.invoke(a, null)).compareTo((Integer) m.invoke(b,
	// null));
	// } else if (type == double.class) {
	...
	// } else if (isImplementsOf(type, Comparable.class)) {
	// ret = ((Comparable) m.invoke(a, null)).compareTo((Comparable) m.invoke(b,
	// null));
	// } else {
	// ret = String.valueOf(m.invoke(a,
	// null)).compareTo(String.valueOf(m.invoke(b, null)));
	// }
	//
	...
	// public List<?> sortByMethod(List<?> list, final String methods[], final
	// String sorts[]) {
