...
public class AppointInquiryEntity extends PageModel {
	...
	/**
	 * 设置graphicCount的值
	 * @param  graphicCount graphicCount的值
	 */
	public void setGraphicCount(Integer graphicCount) {
