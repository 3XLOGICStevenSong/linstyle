...
public class MedicineAnswerEntity extends PageModel {
    /**
     * 
     */
    private static final long serialVersionUID = -6809073311161838781L;

    private Integer answer_id;

    private String answer_user_name;

    private String answer_user_top_pic;
    ...
    public String getAnswer_user_top_pic() {
        return answer_user_top_pic;
    }

    public void setAnswer_user_top_pic(String answer_user_top_pic) {
        this.answer_user_top_pic = answer_user_top_pic;
    }
    ...
    public boolean equals(Object that) {
        ...
        MedicineAnswerEntity other = (MedicineAnswerEntity) that;
        return (this.getAnswer_id() == null ? other.getAnswer_id() == null : this.getAnswer_id().equals(other.getAnswer_id()))
                        && (this.getAnswer_id() == null ? other.getAnswer_id() == null : this.getAnswer_id().equals(other.getAnswer_id()))
                        && (this.getAnswer_user_top_pic() == null ? other.getAnswer_user_top_pic() == null : this.getAnswer_user_top_pic().equals(
                                        other.getAnswer_user_top_pic()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getAnswer_id() == null) ? 0 : getAnswer_id().hashCode());
        result = prime * result + ((getAnswer_user_top_pic() == null) ? 0 : getAnswer_user_top_pic().hashCode());
