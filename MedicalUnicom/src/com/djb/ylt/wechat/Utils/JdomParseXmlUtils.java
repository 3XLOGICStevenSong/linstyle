			...
			if(list!=null&&list.size()>0){
				for (Element element : list) {
					...
					if("timestamp".equals(element.getName())){
						unifieorderResult.setTimestamp(element.getText());
					}
					if("trade_type".equals(element.getName())){
						unifieorderResult.setTrade_type(element.getText());
					}
					if("prepayid".equals(element.getName())){
						unifieorderResult.setPrepayid(element.getText());
					}
					if("partnerid".equals(element.getName())){
						unifieorderResult.setPartnerid(element.getText());
					}
					if("noncestr".equals(element.getName())){
		...
		try { 
			...
			if(list!=null&&list.size()>0){
				for (Element element : list) {
					...
					if("coupon_fee_0".equals(element.getName())){
