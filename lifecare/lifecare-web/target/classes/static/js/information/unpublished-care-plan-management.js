...
//			pageNumber: 1, // 首页页码
	...
	window.operateEvents = {
		...
		'click .edit': function (e, value, row, index) {
			window.location.href = "unpublished-care-plan-edit.html?nursePlanId="+row.nursePlanId;
		},
		//删除行
